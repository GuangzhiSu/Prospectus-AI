...
"[project]/modular/platform-module/web/src/app/api/settings/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function applyApiKeyPatch(patch, body, field, label) {
    const raw = body[field];
    if (typeof raw !== "string") return null;
    const k = raw.trim();
    if (!k || k.startsWith("••")) return null;
    const err = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$app$2d$settings$2d$types$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["validateApiKeyInput"])(k, label);
    if (err) return err;
    patch[field] = k;
    return null;
}
async function GET() {
    try {
        const s = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$app$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["readSettings"])();
        return __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$app$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["maskSettingsForClient"])(s));
    } catch (e) {
...
async function POST(req) {
    try {
        ...
        const patch = {};
        if (typeof body.llmProvider === "string" && (0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$llm$2d$provider$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLlmProviderId"])(body.llmProvider)) {
            patch.llmProvider = body.llmProvider;
        }
        const trimOpt = (v)=>typeof v === "string" ? v.trim() || undefined : undefined;
        ...
        const next = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$app$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["writeSettings"])(patch);
        return __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json((0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$app$2d$settings$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["maskSettingsForClient"])(next));
    } catch (e) {
        const msg = e instanceof Error ? e.message : "Error";
        return __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: msg
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f40123fd._.js.map