...
"[project]/modular/platform-module/web/src/app/api/agent1/results/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const root = (0, __TURBOPACK__imported__module__$5b$project$5d2f$modular$2f$platform$2d$module$2f$web$2f$src$2f$lib$2f$modular$2f$paths$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProspectusRoot"])();
        const outputDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(root, "agent1_output");
        const manifestPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(outputDir, "manifest.json");
        const classificationPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(outputDir, "classification.json");
        let manifest = null;
        let classification = null;
        try {
            const m = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(manifestPath, "utf8");
            manifest = JSON.parse(m);
        } catch  {
        // manifest not found or invalid
        }
        try {
            const c = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readFile(classificationPath, "utf8");
            classification = JSON.parse(c);
        } catch  {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__14ade884._.js.map