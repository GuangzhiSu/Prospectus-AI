  ...
  return (
    <Stack gap={22}>
      <Stack gap={6}>
        ...
        <Text tone="secondary">
          Multi-layer graph mined from {formatInt(DATA.totals.documents)} Exchange prospectuses. The
      ...
      <Stack gap={10}>
        ...
        <Text tone="secondary" size="small">
          Each box is a canonical Exchange section. Edges are <Text as="span" weight="semibold" size="small">typically_precedes</Text>{" "}
