...
_PROFESSIONAL_DELIVERABLES: dict[str, Any] = {
    ...
    "fields": [
        ...
        _field("prof.sponsor.form_M107", "Form M107 (Sponsor's Declaration)",
               name_zh="保荐人声明 M107",
               description="Sponsor's declaration of independence and compliance submitted to Exchange.",
               evidence_source="Sponsor to Exchange",
               report_anchor="§2 / §6"),
        _field("prof.sponsor.form_M108", "Form M108 (Sponsor's Undertaking)",
               name_zh="保荐人承诺 M108",
               description="Sponsor's undertaking to Exchange regarding continuing obligations.",
               evidence_source="Sponsor to Exchange",
               report_anchor="§2 / §6"),
        ...
        _field("prof.ra.accountants_report", "Accountants' Report (Long-Form)",
               ...
               description="Full accountants' report on historical financial information under Exchange App 1A.",
               report_anchor="§2"),
...
_DOC_FORMAT: dict[str, Any] = {
    ...
    "fields": [
        ...
        _field("format.final_submission_format", "Final Exchange Submission Format",
               description="Format required for the final Exchange submission.",
               enum=["Exchange_iFile_XBRL", "PDF"], example="Exchange_iFile_XBRL", report_anchor="§3"),
        ...
        _field("format.clean_version_protocol", "Clean Version Protocol",
               type_="text", description="How clean versions are prepared and numbered for Exchange submission.",
               report_anchor="§3"),
...
_REGULATORY_FRAMEWORKS: dict[str, Any] = {
    ...
    "name_zh": "监管框架",
    "report_anchor": "§6",
    "description": "Exchange regulatory instruments and SFC guidelines that govern prospectus production. Every field records whether the issuer / sponsor has evidenced compliance.",
    "fields": [
        _field("reg.form_M105", "Exchange Form M105 (Sponsor Appointment)",
               description="Formal sponsor appointment filing with Exchange.",
               evidence_source="Sponsor to Exchange",
               report_anchor="§6"),
        _field("reg.form_M106", "Exchange Form M106 (Independent Sponsor Declaration)",
               description="Independent sponsor declaration (where applicable).",
               required=False, evidence_source="Sponsor to Exchange",
               report_anchor="§6"),
        _field("reg.form_M107", "Exchange Form M107 (Sponsor's Declaration on Filing)",
               description="Sponsor's declaration accompanying the A1 filing.",
               evidence_source="Sponsor to Exchange",
               report_anchor="§6"),
        _field("reg.form_M108", "Exchange Form M108 (Sponsor's Undertaking)",
               description="Sponsor's undertaking of continuing obligations.",
               evidence_source="Sponsor to Exchange",
               report_anchor="§6"),
        _field("reg.GL21_10", "Exchange Guidance Letter GL21-10",
               description="Exchange guidance on financial-information disclosure.",
               evidence_source="Exchange GL21-10",
               report_anchor="§6"),
        _field("reg.GL55_13", "Exchange Guidance Letter GL55-13",
               description="Exchange guidance on Waivers and Exemptions disclosure.",
               evidence_source="Exchange GL55-13",
               report_anchor="§6"),
        _field("reg.sponsor_dd_guidelines_3rd_ed", "HK Sponsor Due Diligence Guidelines (3rd Ed., March 2020)",
               type_="text",
               description="SFC/Exchange Due Diligence Guidelines 3rd edition, March 2020 — required reference standard.",
               report_anchor="§6"),
        _field("reg.listing_rules_chapters", "Applicable Exchange Listing Rules Chapters",
               type_="list",
               description="Chapters of the Exchange Listing Rules governing the listing (typically Ch. 7, 8, 11, 19A).",
...
def build_schema() -> dict[str, Any]:
    ...
    schema: dict[str, Any] = {
        ...
        "description": (
            "Structured input schema for Exchange prospectus drafting, derived from the "
