...
```bash
cd pipeline-module/ipo_prospectus_pipeline
python -m venv .venv
...
**Switch with the shell wrapper** (from `pipeline-module/ipo_prospectus_pipeline/`):
...
```
pipeline-module/ipo_prospectus_pipeline/
