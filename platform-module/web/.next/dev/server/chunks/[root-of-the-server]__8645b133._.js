...
"[project]/modular/platform-module/web/src/app/api/agent1/files/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const dataDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(root, "data");
        try {
        ...
        const names = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].readdir(dataDir);
        const items = await Promise.all(names.filter((n)=>isDataFile(n)).map(async (n)=>{
            const full = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dataDir, n);
            const st = await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].stat(full);
            return {
                name: n,
                size: st.size,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8645b133._.js.map